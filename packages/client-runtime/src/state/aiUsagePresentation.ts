 ...
 * is unit-testable.
 *
 * This module is intentionally free of React / atom runtime so it can be used
 * from web, mobile, and other clients.
 */
...
export function formatResetsIn(resetsAt: number | null | undefined, nowMs: number): string | null {

...
export function buildTodayRecapPrompt(input: {
  ...
  return [
    ...
    '- Mention earlier related PRs inline as [PR #N](github-url) (fix) plus that PR\'s Discord thread URL on its own line. Example: [PR #111](url) (fix) then its Discord URL, then "First try was [PR #222](url) (feat)" and that Discord URL, "closed because [PR #333](url) (feat) handled it better" — then #222 and #333 get no blocks of their own.',

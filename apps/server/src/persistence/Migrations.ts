...
import Migration0035 from "./Migrations/035_ProjectionQueuedMessages.ts";
import Migration0036 from "./Migrations/036_SessionIdentityClaims.ts";
import Migration0037 from "./Migrations/037_ProjectionThreadSourceAttribution.ts";
...
export const migrationEntries = [
  ...
  [35, "ProjectionQueuedMessages", Migration0035],
  [36, "SessionIdentityClaims", Migration0036],
  [37, "ProjectionThreadSourceAttribution", Migration0037],
] as const;

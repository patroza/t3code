...
import { formatT3AgentRulesSessionPointer } from "../agentRules/T3AgentRules.ts";

const T3_CODE_PRODUCT_RULES_POINTER = `

## T3 Code product rules
...
const T3_CODE_SESSION_INSTRUCTIONS = `${T3_CODE_PRODUCT_RULES_POINTER}${T3_CODE_BROWSER_TOOL_INSTRUCTIONS}`;

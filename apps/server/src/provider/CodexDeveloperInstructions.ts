...
import { T3_AGENT_RULES_BODY } from "../agentRules/T3AgentRules.ts";

const T3_CODE_PRODUCT_RULES = `
...
const T3_CODE_SESSION_INSTRUCTIONS = `${T3_CODE_PRODUCT_RULES}${T3_CODE_BROWSER_TOOL_INSTRUCTIONS}`;

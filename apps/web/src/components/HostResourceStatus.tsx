import {
  formatHostResourceBytes as formatBytes,
  formatHostResourcePercent as formatPercent,
...
export function HostResourceStatus(props: {
  ...
  const summary = (
    ...
    >
      {getHostResourceMetrics(data).map((metric, index) => (
        <Fragment key={metric.key}>
          ...
          <ResourceMetric
            ...
            {...(metric.key === "load" ? { valueWidthClass: "w-[5ch]" } : {})}
          />
        </Fragment>
      ))}
    </span>

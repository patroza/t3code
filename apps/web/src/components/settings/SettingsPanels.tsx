    ...
    <SettingsPageContainer>
      ...
      <SettingsSection id="behavior" title="Behavior">
        ...
        <SettingsRow
          ...
          serverScoped
          description="Automatically resume interrupted threads after an update, crash, or machine restart. Applies to this environment and all connected environments that support it. Update older servers first. Graceful service restarts and deploys still resume working threads."
          resetAction={
            settings.continueThreadsAfterServerUpdate !==
            DEFAULT_UNIFIED_SETTINGS.continueThreadsAfterServerUpdate ? (
              <SettingResetButton

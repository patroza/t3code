...
/** Web-compatible status labels used by column derivation. */
export type BoardThreadStatusLabel =
  | "Working"
  | "Connecting"
  | "Completed"
  | "Pending Approval"
...
/** Same rules as web `isCompletionUnseen` (Sidebar.logic). */
...
const resolveThreadPr = resolveThreadChangeRequest;
...
export interface BoardColumnInput {
  threadStatusLabel: BoardThreadStatusLabel | null;

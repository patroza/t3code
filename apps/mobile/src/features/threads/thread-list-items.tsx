      ...
      >
          ...
          <View className="flex-row items-center gap-1.5">
            <Text
              className={cn(
                ...
                selected ? "text-thread-selected-foreground" : "text-foreground-muted",
              )}
              numberOfLines={1}
            >
              {thread.title}
        ...
        <Text
          className={cn(
            ...
            selected ? "text-thread-selected-foreground-muted" : "text-foreground-tertiary",
          )}

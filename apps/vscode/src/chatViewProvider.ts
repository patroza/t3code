...
<body>
  <div id="app">
    ...
    <div class="composer">
      ...
      <div class="context"><button id="context" title="Toggle active editor context"><span id="context-label"></span></button></div>
